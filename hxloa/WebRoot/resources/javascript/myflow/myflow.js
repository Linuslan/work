(function (b) {
    ...
    a.rect = function (p, m) {
        ...
        this.toJson = function () {
            ...
            for (var o in E.props) {
                r += o + ":{value:'" + E.props[o].value + "', name: '"+E.props[o].name+"', label: '"+E.props[o].label+"', editor: "+E.props[o].editor+"},"
            }
    ...
    a.path = function (q, n, u, e) {
        ...
        this.toJson = function () {
            ...
            for (var o in B.props) {
                r += o + ":{value:'" + B.props[o].value + "', name: '"+B.props[o].name+"', label: '"+B.props[o].label+"', editor: "+B.props[o].editor+"},"
            }
            if (r.substring(r.length - 1, r.length) == ",") {
                r = r.substring(0, r.length - 1)
            }
    ...
    a.props = function (h, f) {
        ...
        var d = function (n, m, o) {
            ...
            c.show();
            for (var l in m) {
                e.append("<tr><th style='width: 30%;text-align: right;'>" + m[l].label + '：</th><td><div id="p' + l + '" class="editor"></div></td></tr>');
                if (m[l].editor) {
