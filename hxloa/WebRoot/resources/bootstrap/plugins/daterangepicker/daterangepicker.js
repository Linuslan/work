  ...
  // Finally, as a browser global.
    ...
    DateRangePicker.prototype = {
        ...
        renderCalendar: function (calendar, selected, minDate, maxDate, side) {
        	...
        	cnMonth.July = "七月";
        	cnMonth.August = "八月";
        	cnMonth.September = "九月";
        	cnMonth.October = "十月";
        	cnMonth.November = "十一月";
        	cnMonth.December = "十二月";
        	
        	var cnShortMonth = new Object();
        	cnMonth.Jan = "一月";
        	cnMonth.Feb = "二月";
        	cnMonth.Mar = "三月";
        	cnMonth.Apr = "四月";
        	...
        	cnMonth.Nov = "十一月";
        	cnMonth.Dec = "十二月";
            var enMonthName = this.locale.monthNames[calendar[1][1].month()];
            var monthName = cnMonth[enMonthName];
            if(!monthName) {
            	monthName = cnShortMonth[enMonthName];
            }
            var dateHtml = monthName + calendar[1][1].format(" YYYY");
            ...
            $.each(this.locale.daysOfWeek, function (index, dayOfWeek) {
            	var name = cnWeek[dayOfWeek];
            	if(!name) {
            		name= cnShortWeek[dayOfWeek];
            	}
            	if(!name) {
            		name = cnMinWeek[dayOfWeek];
            	}
                html += '<th>' + name + '</th>';
            });
