...
<html>
  ...
  <body>
   	<form id="addButtonForm" action="" class="form-horizontal">
    	<div class="box-body">
			<div class="form-group">
				<label for="name" class="col-sm-2 control-label">按钮名称：</label>
				<div class="col-md-4 col-sm-10 no-padding">
					<input name="button.name" type="text" class="form-control" placeholder="请输入名称">
				</div>
			...
			<div class="form-group">
				...
				<div class="col-md-4 col-sm-10 no-padding">
					<input name="button.value" type="text" class="form-control" placeholder="请输入数字，字母或者下划线">
				</div>
				<label for="pid" class="col-sm-2 control-label">排序值：</label>
				<div class="col-md-4 col-sm-10 no-padding">
					<input name="button.orderNo" type="text" class="form-control" placeholder="请输入数字">
				</div>
			</div>
			<div class="form-group">
				<label for="leaderGroup" class="col-sm-2 control-label">备注：</label>
				<div class="col-md-10 col-sm-10 no-padding">
					<textarea name="button.memo" class="form-control" rows="3" placeholder="请输入"></textarea>
				</div>
			</div>
    	</div>
   	</form>
