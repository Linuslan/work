...
<html>
  ...
  <body>
    <form id="assignUserCompanyForm" action="" class="form-horizontal">
    	<input name="user.id" type="hidden" value="${user.id }" />
    	<div class="box-body">
    		<div class="form-group">
				<label for="text" class="col-sm-3 control-label">分配公司：</label>
				<div class="col-md-8 col-sm-8 no-padding">
					<select multiple="multiple" class="form-control select2" name="companyIds" style="width: 100%">
						...
						<c:forEach items="${companys }" var="company">
							...
							<c:forEach items="${userCompanys }" var="selectCompany">
								<c:choose>
  ...
  <script type="text/javascript">
  	$(function() {
  		$("#assignUserCompanyForm").find(".select2").select2();
  	});
  </script>
</html>
