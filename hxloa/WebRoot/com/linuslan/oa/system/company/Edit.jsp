    	...
    	<div class="box-body">
			<div class="form-group">
				...
				<div class="col-md-9 col-sm-10 no-padding">
					<input name="company.name" type="text" class="form-control" value="${company.name }" placeholder="请输入名称">
				</div>
			</div>
			<div class="form-group">
				<label for="leaderGroup" class="col-sm-2 control-label">排序值：</label>
				<div class="col-md-9 col-sm-10 no-padding">
					<input name="company.orderNo" type="number" class="form-control" value="${company.orderNo }">
				</div>
			</div>
    	</div>
   	</form>
