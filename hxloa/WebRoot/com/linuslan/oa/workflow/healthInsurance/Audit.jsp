...
<html>
  ...
  <body>
   	<form id="auditHealthInsuranceForm" action="" class="form-horizontal">
   		...
   		<div class="nav-tabs-top-border">
   			<ul class="nav nav-tabs">
   				<li class="active">
   					<a href="#healthInsurance" data-toggle="tab">详情</a>
   				</li>
   				<li>
   					<a href="#healthInsuranceAuditorLogs" data-toggle="tab">审核意见</a>
   				</li>
   			</ul>
   			<div class="tab-content">
   				<div class="active tab-pane" id="healthInsurance">
			    	...
			    	<div class="box-body">
			    		<table id="healthInsuranceContentDatagrid_audit"></table>
			    	</div>
   				</div>
   				<div class="tab-pane" id="healthInsuranceAuditorLogs">
   					<div class="box box-solid">
		   				<div class="box-body">
							...
							<div class="col-md-12 col-sm-12 no-padding">
			   					<table id="healthInsuranceauditorlogsdatagrid"></table>
	   							<div id="healthInsuranceauditorlogsdatagridpager"></div>
   							</div>
		   				</div>
		   			</div>
   				</div>
   	...
   	<script type="text/javascript">
   		...
   		function generateHealthInsuranceAuditLogGrid() {
   			var id = $("#auditHealthInsuranceForm").find("input.healthInsuranceId").val();
   			$("#healthInsuranceauditorlogsdatagrid").jqGrid({
                ...
                //width: "100%",
                rowNum: 20,
                pager: "#healthInsuranceauditorlogsdatagridpager"
            });
   		}
   		
   		function generateAuditHealthInsuranceContenGrid() {
   			var id = $("#auditHealthInsuranceForm").find("input.healthInsuranceId").val();
   			$("#healthInsuranceContentDatagrid_audit").jqGrid({
            ...
            $("#healthInsuranceContentDatagrid_audit").jqGrid("setGroupHeaders", {
