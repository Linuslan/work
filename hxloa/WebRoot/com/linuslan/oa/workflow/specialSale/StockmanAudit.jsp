...
<html>
  ...
  <body>
   	<form id="auditSpecialSaleForm" action="" class="form-horizontal">
   		<input id="auditSpecialSaleId" class="specialSaleId" name="specialSale.id" type="hidden" value="${specialSale.id }" />
   		<div class="nav-tabs-top-border">
   			<ul class="nav nav-tabs">
   				<li class="active">
   					<a href="#specialSale_audit" data-toggle="tab">详情</a>
   				</li>
   				<li>
   					<a href="#specialSale_auditLog_audit" data-toggle="tab">审核记录</a>
   				</li>
   			</ul>
   			<div class="tab-content">
   				<div class="active tab-pane" id="specialSale_audit">
			    	...
			    	<div class="box-body" style="overflow-x: auto;">
			    		<table id="specialSaleContentDatagrid_audit"></table>
			    	</div>
			    </div>
			    <div class="tab-pane" id="specialSale_auditLog_audit">
			    	<div class="box box-solid">
		   				<div class="box-body">
							...
							<div class="col-md-12 col-sm-12 no-padding">
			   					<table id="specialSaleAuditorlogsDatagrid_audit"></table>
	   							<div id="specialSaleAuditorlogsDatagridPager_audit"></div>
   							</div>
		   				</div>
		   			</div>
			    </div>
   	...
   	<script type="text/javascript">
   		$(function() {
			...
			setTimeout("buildSpecialSaleContentGrid_audit()", 0);
			setTimeout("buildSpecialSaleLogGrid_audit()", 0);
   		});
   		
   		function buildSpecialSaleLogGrid_audit() {
   			$("#specialSaleAuditorlogsDatagrid_audit").jqGrid({
                url: getRoot() + "workflow/auditlog/queryOpinionPage.action?wfType=specialSale&wfId="+$("#auditSpecialSaleId").val(),
                mtype: "POST",
                shrinkToFit: true,
                autowidth: true,
                scrollrows: false,
                ...
                //width: "100%",
                rowNum: 20,
                pager: "#specialSaleAuditorlogsDatagridPager_audit"
            });
   		}
   		
   		function buildSpecialSaleContentGrid_audit() {
   			var specialSaleId = $("#auditSpecialSaleForm").find("input[type=hidden][name='specialSale.id']").val();
   			$("#specialSaleContentDatagrid_audit").jqGrid({
                mtype: "POST",
