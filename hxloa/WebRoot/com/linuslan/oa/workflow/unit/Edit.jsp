...
<html>
  ...
  <body>
   	<form id="editUnitForm" action="" class="form-horizontal">
   		<input type="hidden" value="${unit.id }" name="unit.id" />
    	<div class="box-body">
			<div class="form-group">
				<label for="name" class="col-md-2 col-sm-4 control-label">单位名称：</label>
				<div class="col-md-3 col-sm-8 no-padding">
					<input value="${unit.name }" name="unit.name" type="text" class="form-control">
				</div>
				<div class="col-md-1 col-sm-12 no-padding"></div>
				<label for="name" class="col-md-2 col-sm-4 control-label">排序值：</label>
				<div class="col-md-3 col-sm-8 no-padding">
					<input value="${unit.orderNo }" name="unit.orderNo" type="number" class="form-control">
				</div>
			</div>
			<div class="form-group">
				<label for="name" class="col-md-2 col-sm-4 control-label">联系电话：</label>
				<div class="col-md-3 col-sm-8 no-padding">
					<input value="${unit.telephone }" name="unit.telephone" type="text" class="form-control">
				</div>
				<div class="col-md-1 col-sm-12 no-padding"></div>
			...
			<div class="form-group">
				...
				<div class="col-md-9 col-sm-10 no-padding">
					<input value="${unit.address }" name="unit.address" type="text" class="form-control">
				</div>
			</div>
			<div class="form-group">
				<label for="leaderGroup" class="col-sm-2 control-label">备注：</label>
				<div class="col-md-9 col-sm-10 no-padding">
					<textarea name="unit.remark" class="form-control" rows="3">${unit.remark }</textarea>
				</div>
			</div>
    	</div>
   	</form>
