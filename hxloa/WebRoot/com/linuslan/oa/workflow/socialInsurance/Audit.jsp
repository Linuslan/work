...
<html>
  ...
  <body>
   	<form id="auditSocialInsuranceForm" action="" class="form-horizontal">
   		...
   		<div class="nav-tabs-top-border">
   			<ul class="nav nav-tabs">
   				<li class="active">
   					<a href="#socialInsurance" data-toggle="tab">详情</a>
   				</li>
   				<li>
   					<a href="#socialInsuranceAuditorLogs" data-toggle="tab">审核意见</a>
   				</li>
   			</ul>
   			<div class="tab-content">
   				<div class="active tab-pane" id="socialInsurance">
			    	...
			    	<div class="box-body">
			    		<table id="socialInsuranceContentDatagrid_audit"></table>
			    	</div>
   				</div>
   				<div class="tab-pane" id="socialInsuranceAuditorLogs">
   					<div class="box box-solid">
		   				<div class="box-body">
							...
							<div class="col-md-12 col-sm-12 no-padding">
			   					<table id="socialInsuranceauditorlogsdatagrid"></table>
	   							<div id="socialInsuranceauditorlogsdatagridpager"></div>
   							</div>
		   				</div>
		   			</div>
   				</div>
   	...
   	<script type="text/javascript">
   		...
   		function generateSocialInsuranceAuditLogGrid() {
   			var id = $("#auditSocialInsuranceForm").find("input.socialInsuranceId").val();
   			$("#socialInsuranceauditorlogsdatagrid").jqGrid({
                ...
                //width: "100%",
                rowNum: 20,
                pager: "#socialInsuranceauditorlogsdatagridpager"
            });
   		}
   		
   		function generateAuditSocialInsuranceContenGrid() {
   			var id = $("#auditSocialInsuranceForm").find("input.socialInsuranceId").val();
   			$("#socialInsuranceContentDatagrid_audit").jqGrid({
                ...
                colModel: [{
                	...
                	label: "缴费比率", name: "userEndowmentRate", width: 110, align: "center"
                }, {//个人基本养老保险
            ...
            $("#socialInsuranceContentDatagrid_audit").jqGrid("setGroupHeaders", {
