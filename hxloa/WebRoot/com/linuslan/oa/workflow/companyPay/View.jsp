...
<html>
  ...
  <body>
   	<form id="viewCompanyPayForm" action="" class="form-horizontal">
   		<input type="hidden" id="viewCompanyPayId" value="${companyPay.id }" />
   	...
   	<script type="text/javascript">
   		$(function() {
   			$("#viewCompanyPayForm .textarea").each(function() {
