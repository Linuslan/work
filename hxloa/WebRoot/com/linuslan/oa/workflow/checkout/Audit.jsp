...
<html>
  ...
  <body>
   	<form id="auditCheckoutForm" action="" class="form-horizontal">
   		<input class="checkoutId" type="hidden" name="checkout.id" id="auditCheckoutId" value="${checkout.id }" />
   		<div class="nav-tabs-top-border">
   			<ul class="nav nav-tabs">
   				<li class="active">
   					<a href="#checkout_audit" data-toggle="tab">详情</a>
   				</li>
   				<li>
   					<a href="#checkoutAuditorLogs_audit" data-toggle="tab">审核意见</a>
   				</li>
   			</ul>
   			<div class="tab-content">
   				<div class="active tab-pane" id="checkout_audit">
			    	...
			    	<div class="box-body">
			    		<table id="checkoutContentDatagrid_audit"></table>
			    	</div>
			    </div>
			   	<div class="tab-pane" id="checkoutAuditorLogs_audit">
   					<div class="box box-solid">
		   				<div class="box-body">
							...
							<div class="col-md-12 col-sm-12 no-padding">
			   					<table id="checkoutAuditAuditorlogsDatagrid"></table>
	   							<div id="checkoutAuditAuditorlogsDatagridPager"></div>
   							</div>
		   				</div>
		   			</div>
   				</div>
   	...
   	<script type="text/javascript">
   		$(function() {
			...
			setTimeout("generateAuditCheckoutAuditLogGrid()", 0);
			setTimeout("generateAuditCheckoutContenGrid()", 0);
   		});
   		
   		function generateAuditCheckoutAuditLogGrid() {
   			var id = $("#auditCheckoutForm").find("input.checkoutId").val();
   			$("#checkoutAuditAuditorlogsDatagrid").jqGrid({
                ...
                //width: "100%",
                rowNum: 20,
                pager: "#checkoutAuditAuditorlogsDatagridPager"
            });
   		}
   		
   		function generateAuditCheckoutContenGrid() {
   			var id = $("#auditCheckoutForm").find("input.checkoutId").val();
   			$("#checkoutContentDatagrid_audit").jqGrid({
