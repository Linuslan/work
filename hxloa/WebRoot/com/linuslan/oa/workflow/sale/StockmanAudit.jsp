  ...
  <body>
   	<form id="auditSaleForm" action="" class="form-horizontal">
   		...
   		<div class="nav-tabs-top-border">
   			<ul class="nav nav-tabs">
   				<li class="active">
   					<a href="#sale_stockmanAudit" data-toggle="tab">详情</a>
   				</li>
   				<li>
   					<a href="#sale_invoice_stockmanAudit" data-toggle="tab">开票信息</a>
   				</li>
   				<li>
   					<a href="#sale_stockmanAuditLog_stockmanAudit" data-toggle="tab">审核记录</a>
   				</li>
   			</ul>
   			<div class="tab-content">
   				<div class="active tab-pane" id="sale_stockmanAudit">
			    	...
			    	<div class="box-body" style="overflow-x: auto;">
			    		<table id="saleContentDatagrid_stockmanAudit"></table>
			    	</div>
			    </div>
			    <div class="tab-pane" id="sale_invoice_stockmanAudit">
			    ...
			    <div class="tab-pane" id="sale_stockmanAuditLog_stockmanAudit">
			    	<div class="box box-solid">
		   				<div class="box-body">
							...
							<div class="col-md-12 col-sm-12 no-padding">
			   					<table id="saleAuditorlogsDatagrid_stockmanAudit"></table>
	   							<div id="saleAuditorlogsDatagridPager_stockmanAudit"></div>
   							</div>
		   				</div>
		   			</div>
			    </div>
   	...
   	<script type="text/javascript">
   		$(function() {
			...
			setTimeout("buildSaleContentGrid_stockmanAudit()", 0);
			setTimeout("buildSaleLogGrid_stockmanAudit()", 0);
   		});
   		
   		function buildSaleLogGrid_stockmanAudit() {
   			$("#saleAuditorlogsDatagrid_stockmanAudit").jqGrid({
                url: getRoot() + "workflow/auditlog/queryOpinionPage.action?wfType=sale&wfId="+$("#auditSaleId").val(),
                mtype: "POST",
                shrinkToFit: true,
                autowidth: true,
                scrollrows: false,
                ...
                //width: "100%",
                rowNum: 20,
                pager: "#saleAuditorlogsDatagridPager_stockmanAudit"
            });
   		}
   		
   		function buildSaleContentGrid_stockmanAudit() {
   			var saleId = $("#auditSaleForm").find("input[type=hidden][name='sale.id']").val();
   			$("#saleContentDatagrid_stockmanAudit").jqGrid({
                mtype: "POST",
