...
<html>
  ...
  <body>
   	<form id="viewPurchaseForm" action="" class="form-horizontal">
   		<input class="purchaseId" type="hidden" name="purchase.id" id="viewPurchaseId" value="${purchase.id }" />
   		<div class="nav-tabs-top-border">
   			<ul class="nav nav-tabs">
   				<li class="active">
   					<a href="#purchase_view" data-toggle="tab">详情</a>
   				</li>
   				<li>
   					<a href="#purchaseAuditorLogs_view" data-toggle="tab">审核意见</a>
   				</li>
   			</ul>
   			<div class="tab-content">
   				<div class="active tab-pane" id="purchase_view">
			    	...
			    	<div class="box-body">
			    		<table id="purchaseContentDatagrid_view"></table>
			    	</div>
			    </div>
			   	<div class="tab-pane" id="purchaseAuditorLogs_view">
   					<div class="box box-solid">
		   				<div class="box-body">
							<div class="col-md-12 col-sm-12 no-padding">
			   					<table id="purchaseViewAuditorlogsDatagrid"></table>
	   							<div id="purchaseViewAuditorlogsDatagridPager"></div>
   							</div>
		   				</div>
		   			</div>
   				</div>
   	...
   	<script type="text/javascript">
   		$(function() {
			...
			setTimeout("generatePurchaseAuditLogGrid()", 0);
			setTimeout("generatePurchaseContentGrid_view()", 0);
   		});
   		
   		function generatePurchaseAuditLogGrid() {
   			var id = $("#viewPurchaseForm").find("input.purchaseId").val();
   			$("#purchaseViewAuditorlogsDatagrid").jqGrid({
                ...
                //width: "100%",
                rowNum: 20,
                pager: "#purchaseViewAuditorlogsDatagridPager"
            });
   		}
   		
   		function generatePurchaseContentGrid_view() {
   			var id = $("#viewPurchaseForm").find("input.purchaseId").val();
   			$("#purchaseContentDatagrid_view").jqGrid({
